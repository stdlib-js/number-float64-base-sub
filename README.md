...
```javascript
sub = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float64-base-sub@v0.1.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var sub = require( 'path/to/vendor/umd/number-float64-base-sub/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/number-float64-base-sub@v0.1.0-umd/browser.js"></script>
```
